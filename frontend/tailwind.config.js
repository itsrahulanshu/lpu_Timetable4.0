  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'xl-colored': '0 20px 40px rgba(59, 130, 246, 0.15)',
      ...
      backgroundImage: {
        ...
        'gradient-mesh': 'radial-gradient(at 27% 37%, hsla(215, 98%, 61%, 0.2) 0px, transparent 50%), radial-gradient(at 97% 21%, hsla(125, 98%, 72%, 0.2) 0px, transparent 50%), radial-gradient(at 52% 99%, hsla(354, 98%, 61%, 0.2) 0px, transparent 50%)',
      },
      animation: {
